        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="index.php">
                    <img class="logo-light" src="assets/img/logo/MEM.jpg" alt="logo">
                    <img class="logo-dark" src="assets/img/logo/EMU.jpg" alt="logo">
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a href="./login.php" class="nav-link">My Page</a></li>
                                <li class="nav-item"><a href="./login.php" class="nav-link active">Meet Others</a></li>
                                <li class="nav-item"><a href="./login.php" class="nav-link">Suvey</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a href="about-us.html" class="nav-link">General Info</a></li>
                                <li class="nav-item"><a href="news-and-blog.html" class="nav-link">How to apply</a></li>
                                <li class="nav-item"><a href="https://catalog.emich.edu/preview_program.php?catoid=42&poid=18430&_gl=1*1c2zafk*_gcl_au*NDk1NzgxMTA5LjE3NDAyNDQwNDU." class="nav-link">Curriculum</a></li>
                                <li class="nav-item"><a href="./facaulty.php" class="nav-link">Faculty</a></li>
                                <li class="nav-item"><a href="./memberhof.php" class="nav-link">Hall of Fame</a></li>
