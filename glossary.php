...
$sql = "SELECT COUNT(*) FROM glossary WHERE EMCID='".$emcid."' ORDER BY term";
...
$sql = "SELECT term, definition FROM glossary WHERE EMCID='".$emcid."' ORDER BY term LIMIT $offset, $rowsperpage";
$result = mysqli_query($connection,$sql) or trigger_error("SQL", E_USER_ERROR);

// while there are rows to be fetched...
$str="";
$str.= "<table border='2' align='center' width= 50% padding='2'> <tr><th> Term </th> <th> Definition </th> </tr>";
