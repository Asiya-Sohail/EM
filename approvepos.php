...
if (!empty($_GET["eid"])){$_SESSION['pos_id']=$_GET["eid"];}
?>
<?php
...
if (array_key_exists('submit-approval', $_POST)) {
	...
	//echo $_SESSION['pos_id']; 
       ...
       $result = mysqli_query($connection,$query);
			if ($result) {
				$message = "You successfully approved the POS";
				$_SESSION['pos_id']="";
			} else {
				$message = "The POS couldn't be approved.";
				$message .= "<br />" . mysqli_error($connection);
			}
		} else {
			if (count($errors) == 1) {
...
<h2 >Master of Science in Enginnering Management</h2><br/>
 <br/>
			...
			<br/>
 <h3> List of the students who have submitted their POS for approval</h3><br/>

<!--******************************************************************List of the students who have submit their POS****************************************************-->
<?php
    if ( empty($errors) ){
    $qry = "SELECT EID, firstname, lastname, username, email FROM member WHERE possubmitted='1' AND posapproved='0'";
       ...
       {
        $str .="<tr><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['username']."</td><td>".$row['email']."</td><td><a href=approvepos.php?eid=". $row['EID'] .">Click here</a></td></tr>";
       }
       $str .="</table>";
       echo $str;
      // }
      }else {echo "There is no POS to Approve"; $_SESSION['pos_id']="";}
		}
...
<div id="tabs">
	<ul>
		...
		<li><a href="#tabs-5">Review and Approve POS</a></li>
	</ul>


	<div id="tabs-1"><!--**********************************Main Section- tab-1 *************************************************-->
	 <form name="chprofile" action="approvepos.php#tabs-1" method="post">
     <div align= 'center'> <br/>
 ...
 <form name="chcore" action="approvepos.php#tabs-2" method="post">
  <div align= 'center'> <br/>
    <table border= "1" cellspacing="0">
  ...
  <form name="chtrack" action="approvepos.php#tabs-3" method="post">
  <div align= 'center'> <br/>
    <table border= "1" cellspacing="0">
          ...
          <?php if($row['track']==4){//this is quality track that is looklike elective classes
                ...
                $str .= "<tr colspan='6'><th colspan='6'><b>Restricted Quality Track Courses(Hours Required 18 hrs)</b></th></tr>";
                 ...
                 while($row = mysqli_fetch_assoc($result)){
                            ...
                            $str .="<td><a href=approvepos.php?elid=". $row['ELID'] ."#tabs-3>Delete</a></td>";
                 }
                 echo $str;
  ...
  <div id="tabs-4"><!--**********************************Elective Courses *************************************************-->
    ...
    <form name="chelective" action="approvepos.php#tabs-4" method="post">
  <div align= 'center'> <br/>
    <table border= "1" cellspacing="0">
         ...
         <tr colspan="6"><th colspan="6"><b>Restricted Elective Courses(Hours Required 18 hrs)</pre></b></th></tr>
          <?php
          $eid=$_SESSION['pos_id'];
          ...
          while($row = mysqli_fetch_assoc($result)){
             ...
             $str .="<td>".$row['grade']."</td>";
             $str .="<td>".$row['certification']."</td>";
             $str .="<td><a href=approvepos.php?elid=". $row['ELID'] ."#tabs-4>Delete</a></td></tr>";
          }
          echo $str;
          ////////////////mysql_close($connection);
...
<a href="" onclick="printSelection(document.getElementById('test'));return false"><img src="style/images/print.jpg" /></a> <br/>
    ...
    <!--*****Track Section Summery******-->
          <tr colspan='6'><th colspan='6'><b>Restricted Track Courses</b></th></tr>
          <?$pos_id=$_SESSION['pos_id'];?>
     ...
     <!--*****Elective Section Summery******-->
          <tr colspan="6"><th colspan="6"><b>Restricted Elective Courses(Hours Required 18 hrs)</b></th></tr>
          <?php
          $eid=$_SESSION['pos_id'];
          $result = mysqli_query($connection,"SELECT * FROM elective WHERE elective.EID='".$eid."' AND elective.qualitytrack=0");
          $str="";
  ...
  <form name="submit-approval" method="post" enctype="multipart/form-data"  action="approvepos.php#tabs-5">
  <table border="1" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <th>Approve the POS </th> <td><input name="Submit" type="submit" value="Approve the POS"></td>
    </tr>
    <tr>
  </table>
