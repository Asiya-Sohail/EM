...
<?php //****Form processing section****\\
	...
	if (array_key_exists('ratemember', $_POST)) {
		...
		if ( empty($errors) ) {
			$query = "INSERT INTO pevaluation (
							CMTID,EID,rate1,rate2,rate3,rate4,rate5,rate6,rate7,rate8,rate9,rate10,rate11
						) VALUES (
							'".$CMTID."','".$eid."', '".$rate1."','".$rate2."','".$rate3."', '".$rate4."','".$rate5."','".$rate6."', '".$rate7."','".$rate8."','".$rate9."','".$rate10."','".$rate11."'
						)";
	...
	<div id="tabs-2"><!--------------------------------Begin of tab-2 ---------------------------------->
		...
		<form name="ratemember" method="post" action="memberevaluation.php#tabs-2">
			...
			<table width="300" border="1" cellspacing="0">
                ...
                <tr><td><input type="radio" name="rate7" value="1" /> Wa s  always talking – never allowed anyone else to speak <br/>
