...
<?/////////////////////////////*********************************************form******************************************\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\?>
<h2 >Master of Science in Enginnering Management</h2><br/>
 <br/>
...
<?php
	 ...
	 if ($row['possubmitted']==1){echo"1. Your POS submitted for approval";}Else{echo"1. You haven't submitted your POS for approval yet ! ! !";}
	 echo"<br/><br>";
	 if ($row['posapproved']==1){echo"2. Your POS has been approved";}Else{echo"2. Your POS hasn't approved yet !";}
...
<div id="tabs">
	<ul>
		...
		<li><a href="#tabs-5">Submit</a></li>
	</ul>


	<div id="tabs-1"><!--**********************************Main Section- tab-1 *************************************************-->
	 <form name="chprofile" action="submit-pos.php#tabs-1" method="post">
     <div align= 'center'> <br/>
         <table border= "1" cellspacing="0">
                ...
                <tr colspan="2"><td colspan="2" align="right"><input type="submit" name="submit" value="Save" /></td></tr>
         </table><br/>
 ...
 <form name="chcore" action="submit-pos.php#tabs-2" method="post">
  <div align= 'center'> <br/>
    <table border= "1" cellspacing="0">
        ...
        <tr colspan="5"><td colspan="5" align="right"><input type="submit" name="submit" value="Save" /></td></tr>
     </table>
  ...
  <form name="chtrack" action="submit-pos.php#tabs-3" method="post">
  <div align= 'center'> <br/>
    <table border= "1" cellspacing="0">
         <tr><th colspan="5"><b><?if($row['track']==1){echo "Design and Manufacturing Track F2007";} if( $row['track']==2){echo "Lean Enterprise Systems Track F2007";} if( $row['track']==3){echo "Project/Program Management Track 2007";} if( $row['track']==4){echo "Quality Certificate Track F2007";}if( $row['track']==5){echo "R & D (Development Project) Track F2007";}?> (Hours Required 18 hrs)</b></th></tr>
          ...
          <?php if($row['track']==4){//this is quality track that is looklike elective classes
                ...
                $str .= "<tr colspan='6'><td colspan='6' align='right'><input type='submit' name='submit' value='Save' /></td></tr>";
                $str .= "<tr colspan='6'><th colspan='6'><b>Restricted Quality Track Courses(Hours Required 18 hrs)</b></th></tr>";
                 ...
                 while($row = mysqli_fetch_assoc($result)){
                            ...
                            $str .="<td><a href=submit-pos.php?elid=". $row['ELID'] ."#tabs-3>Delete</a></td>";
                 }
                 echo $str;
                 //mysql_close($connection);
               }else{ echo "<tr colspan='5'><td colspan='5' align='right'><input type='submit' name='submit' value='Save' /></td></tr>"; }
               ?>
     </table>
  ...
  <div id="tabs-4"><!--**********************************Elective Courses *************************************************-->
    ...
    <form name="chelective" action="submit-pos.php#tabs-4" method="post">
  <div align= 'center'> <br/>
    <table border= "1" cellspacing="0">
         <tr><td>Course Name<br/><input name="elec_name" type="text" class="textfield" id="elec_name" /></td><td>Hours<br/><input name="elec_chr" type="text" class="textfield" id="elec_chr" size= "3" /></td><td>Semester<br/><input name="elec_semester" type="text" class="textfield" id="elec_semester" size= "3"/></td><td>Grade<br/><input name="elec_grade" type="text" class="textfield" id="elec_grade" size= "3"/></td><td>Certification<br/><input name="elec_certificate" type="text" class="textfield" id="elec_certificate"  size= "10"/></td><td size= "3">Action</td></tr>

         <tr colspan="6"><td colspan="6" align="right"><input type="submit" name="submit" value="Save" /></td></tr>
         
         <tr colspan="6"><th colspan="6"><b>Restricted Elective Courses</pre></b></th></tr>
          <?php
          $eid=$_SESSION['pos_id'];
          ...
          while($row = mysqli_fetch_assoc($result)){
             ...
             $str .="<td>".$row['grade']."</td>";
             $str .="<td>".$row['certification']."</td>";
             $str .="<td><a href=submit-pos.php?elid=". $row['ELID'] ."#tabs-4>Delete</a></td></tr>";
          }
          echo $str;
          ////////////////mysql_close($connection);
...
<a href="" onclick="printSelection(document.getElementById('test'));return false"><img src="style/images/print.jpg" /></a> <br/>
    ...
    <!--*****Track Section Summery******-->
          <tr colspan='6'>
            <th colspan='6'><b>Restricted Track Courses (Hours Required 18 hrs)</b></th></tr>
          <?$pos_id=$_SESSION['pos_id'];?>
     ...
     <!--*****Elective Section Summery******-->
          <tr colspan="6"><th colspan="6"><b>Restricted Elective Courses</b></th></tr>
          <?php
          $eid=$_SESSION['pos_id'];
          $result = mysqli_query($connection,"SELECT * FROM elective WHERE elective.EID='".$eid."' AND elective.qualitytrack=0");
          $str="";
 ...
 <form name="submit-approval" method="post" enctype="multipart/form-data"  action="submit-pos.php#tabs-5">
  <table border="1" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <th>Submit your Program of Study</th> <td><input name="Submit" type="submit" value="Submit for Approval"></td>
    </tr>
    <tr>
  </table>
