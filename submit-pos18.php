...
if (array_key_exists('chelective', $_POST)) {
   ...
   $delresult=mysqli_query( "DELETE FROM elective WHERE ELID = '".$_GET['elid']."'");
...
<div id="tabs">
	<ul>
		...
		<li><a href="#tabs-5">Submit for approval</a></li>
	</ul>
...
<a href="" onclick="printSelection(document.getElementById('test'));return false"><img src="style/images/print.jpg" /></a> <br/>
 ...
 <form name="submit-approval" method="post" enctype="multipart/form-data"  action="submit-pos.php#tabs-5">
  <table border="1" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <th>Submit your Program of Study for approval </th> <td><input name="Submit" type="submit" value="Submit for Approval"></td>
    </tr>
    <tr>
  </table>
