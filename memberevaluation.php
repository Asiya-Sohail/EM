...
<?php //****Form processing section****\\
	...
	if (array_key_exists('ratemember', $_POST)) {
		...
		#$rate6 = empty(trim(($_POST['rate6'])))? 0 : trim(($_POST['rate6']));
		...
		if(!isset($_POST['rate10']))
		{
			$rate10 = 0;
		}
		else {
			$rate10 = trim(($_POST['rate10']));
			}

		$CMTID = trim(($_POST['CMTID']));
                $CMTID = str_replace('/', '', $CMTID);
		...
		if ( empty($errors) ) {
			$query = "INSERT INTO peerevaluation (
							CMTID,EID,rate1,rate2,rate3,rate4,rate5,rate6,rate7,rate8,rate9,rate10,skilldev,comment
						) VALUES (
							'".$CMTID."','".$eid."', '".$rate1."','".$rate2."','".$rate3."', '".$rate4."','".$rate5."','".$rate6."', '".$rate7."','".$rate8."','".$rate9."'
							,'".$rate10."','".$skilldev."','".$comment."'
						)";
			$result = mysqli_query($connection,$query);
			if ($result) {
				$message = "You successfully rate one of your temmate.";
			} else {
				$message = "You cannot rate.".$query;
	...
	<div id="tabs-2"><!--------------------------------Begin of tab-2 ---------------------------------->
		...
		<form name="ratemember" method="post" action="memberevaluation.php#tabs-2">
			...
			<table width="300" border="1" cellspacing="0">
				<tr><th>1. Rate your teammate on the effort she/he put into researching and gathering background information for the desig</th></tr>
                <tr><td><input type="radio" name="rate1" value="1" /> Did not collect any information that relates to the project <br/>
						...
						<input type="radio" name="rate1" value="4" /> Collected great deal of information and most of it related to the project <br/>           
                        <input type="radio" name="rate1" value="5" /> Collected a great deal of information and all if it related to the project <br/>           
                </td></tr>
                ...
                <tr><td><input type="radio" name="rate2" value="1" /> Did not relay any information to other teammates <br/>
                        ...
                        <input type="radio" name="rate2" value="4" /> Relayed some information and all of it related to the project <br/>
						<input type="radio" name="rate2" value="5" /> Relayed a great deal of information and all of it related to the project <br/>           
                </td></tr>
                ...
                <tr><td><input type="radio" name="rate3" value="1" /> Did not complete team assignments <br/>
                        ...
                        <input type="radio" name="rate3" value="3" /> Completed some assignments on time <br/>
						<input type="radio" name="rate3" value="4" /> Completed most of the team assignments on time <br/>
                        <input type="radio" name="rate3" value="5" /> Completed all of the team assignments on time <br/>           
                </td></tr>
                ...
                <tr><td><input type="radio" name="rate4" value="1" /> Did not perform any of the duties of the assigned team role <br/>
						...
						<input type="radio" name="rate4" value="3" /> Performed some duties of assigned team role<br/>
                        <input type="radio" name="rate4" value="4" /> Performed most  duties of assigned team role <br/>
                        <input type="radio" name="rate4" value="5" /> Performed all duties of assigned team role <br/>           
                </td></tr>
                ...
                <tr><td><input type="radio" name="rate5" value="1" /> Always relied on others to do the work <br/>
						...
						<input type="radio" name="rate5" value="3" /> Often did the assigned work<br/>
                        <input type="radio" name="rate5" value="4" /> Usually did the assigned work – rarely needed reminding <br/>
                        <input type="radio" name="rate5" value="5" /> Always did the assigned work without having to be reminde<br/>           
                </td></tr>
                <tr><th>6. Rate your teammate on how well he/she attended meetings</th></tr>
                <tr><td>
						<input type="radio" name="rate6" value="1" /> Did not attend team meetings <br/>
						<input type="radio" name="rate6" value="2" /> Attended few team meetings.  Did not inform other group members they would be absent <br/>
                		<input type="radio" name="rate6" value="3" /> Attended some team meetings and seldom informed others they would be absent<br/>
                        <input type="radio" name="rate6" value="4" /> Attended most meetings and informed others when he/she could not attend <br/>
                        <input type="radio" name="rate6" value="5" /> Attended all group meeting<br/>           
                </td></tr>
                <tr><th>7. Rate the team member on how well she/he listened to others in the group</th></tr>
                <tr><td>
						<input type="radio" name="rate7" value="1" /> Did not participate in group activities <br/>
						<input type="radio" name="rate7" value="2" /> Was  always talking – never allowed anyone else to speak <br/>
                		<input type="radio" name="rate7" value="3" /> Usually did most of the talking – rarely allowed others to speak<br/>
                        <input type="radio" name="rate7" value="4" /> Listened, but occasionally talked too much <br/>
                        <input type="radio" name="rate7" value="5" /> Listened well and spoke without dominating the conservation<br/>           
                </td></tr>
                <tr><th>8. Rate the team member on how well he/she cooperates with others in the group</th></tr>
                <tr><td>
						<input type="radio" name="rate8" value="1" /> Did not cooperate with teammates <br/>
						<input type="radio" name="rate8" value="2" /> Usually argued with teammates <br/>
                		<input type="radio" name="rate8" value="3" /> Sometimes argued with teammates<br/>
                        <input type="radio" name="rate8" value="4" /> Rarely argued with other team members <br/>
                        <input type="radio" name="rate8" value="5" /> Never argued with teammates<br/>           
                </td></tr>
                <tr><th>9. Rate your team member on how well she/he made fair decisions</th></tr>
                <tr><td>
						<input type="radio" name="rate9" value="1" /> Did not participate in decision making process <br/>
						<input type="radio" name="rate9" value="2" /> Usually wanted to have things their way <br/>
                		<input type="radio" name="rate9" value="3" /> Often sided with friends instead of considering all views<br/>
                        <input type="radio" name="rate9" value="4" /> Usually considered all views<br/>
                        <input type="radio" name="rate9" value="5" /> Always helped the team to reach a fair decision<br/>           
                </td></tr>
				...
				<tr><th>10. Considering the whole team experience, provide an overall rating of this teammate</th></tr>
                <tr><td>
						<input type="radio" name="rate10" value="1" /> Ineffective as a team member <br/>
						<input type="radio" name="rate10" value="2" /> Marginal team member, missing several skills and abilities <br/>
                		<input type="radio" name="rate10" value="3" /> Neutral – neither good or bad<br/>
                        <input type="radio" name="rate10" value="4" /> Adequate team member, minor development needed in skills and abilities<br/>
                        <input type="radio" name="rate10" value="5" /> Effective team member, displays and practices skills and abilities <br/>           
                </td></tr>
				
				<tr><th>11. As learning is a lifelong event, from your view of the teammate, provide one skill type that could use development (e.g. communication, responsibility, delegation, etc.)</th></tr>
                <tr><td>
						<textarea name="skilldev" cols="50%" rows="5"></textarea>
                </td></tr>
				
				<tr><th>12. Overall comment on the team member </th></tr>
                <tr><td>
